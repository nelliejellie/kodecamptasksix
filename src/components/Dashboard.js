  ...
  return (
    <div className='bg-gray-2 h-[100%] p-8 md:h-[110vh]'>
        <div className='bg-white h-[98%] rounded-lg shadow-lg flex justify-center items-start md:h-[105vh]'>
            <div className='bg-[#FF8E58] rounded-lg w-[80%] mt-8 flex justify-between items-center md:h-[95%] md:flex-col md:justify-around sm:w-[90%]'>
              <div className='w-[50%] flex flex-col justify-center items-center text-white md:w-[100%] '>
                <h1 className='mx-auto font-bold text-3xl md:text-2xl sm:text-xl'>Welcome {user.displayName}</h1>
